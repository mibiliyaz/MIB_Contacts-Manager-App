...
public class SignUp extends JDialog {
	...
	JLabel lblName,lblLoginID,lblPassword,lblSecret,PgTitle,SignInText;
	JLabel image=new JLabel(new ImageIcon("MIB.png"));
    JTextField NameTextField, LoginIDTextField;
    ...
    public SignUp() {
        ...
        lblLoginID.setBounds(40,330,150,30);//x,y,width,height
        ...
        LoginIDTextField.setBounds(170,330,150,30);
        ...
        SignUpBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String name = (NameTextField.getText()!=" Enter your Name")?NameTextField.getText():"";
	                String email = (LoginIDTextField.getText()!=" Enter your LoginID")?LoginIDTextField.getText():"";
